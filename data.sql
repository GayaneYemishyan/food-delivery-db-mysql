-- ============================================================
-- Food Delivery Database - Sample Data (DML)
...
('Alice',     'Johnson',   'alice.johnson@email.com',    SHA2('pass1234',256),  'alicej',      '2024-01-05 09:00:00', 'customer'),
('Bob',       'Smith',     'bob.smith@email.com',        SHA2('pass1234',256),  'bobsmith',    '2024-01-06 10:00:00', 'customer'),
('Carol',     'Williams',  'carol.w@email.com',          SHA2('pass1234',256),  'carolw',      '2024-01-07 11:00:00', 'customer'),
('David',     'Brown',     'david.b@email.com',          SHA2('pass1234',256),  'davidb',      '2024-01-08 08:30:00', 'customer'),
('Eva',       'Davis',     'eva.davis@email.com',        SHA2('pass1234',256),  'evad',        '2024-01-09 14:00:00', 'customer'),
('Frank',     'Miller',    'frank.m@email.com',          SHA2('pass1234',256),  'frankm',      '2024-01-10 09:15:00', 'customer'),
('Grace',     'Wilson',    'grace.w@email.com',          SHA2('pass1234',256),  'gracew',      '2024-01-11 10:45:00', 'customer'),
('Henry',     'Moore',     'henry.mo@email.com',         SHA2('pass1234',256),  'henrym',      '2024-01-12 13:00:00', 'customer'),
('Isla',      'Taylor',    'isla.t@email.com',           SHA2('pass1234',256),  'islat',       '2024-01-13 15:30:00', 'customer'),
('Jack',      'Anderson',  'jack.a@email.com',           SHA2('pass1234',256),  'jacka',       '2024-01-14 08:00:00', 'customer'),
('Karen',     'Thomas',    'karen.t@email.com',          SHA2('pass1234',256),  'karent',      '2024-01-15 11:20:00', 'customer'),
('Liam',      'Jackson',   'liam.j@email.com',           SHA2('pass1234',256),  'liamj',       '2024-01-16 12:00:00', 'customer'),
('Mia',       'White',     'mia.w@email.com',            SHA2('pass1234',256),  'miaw',        '2024-01-17 09:30:00', 'customer'),
('Noah',      'Harris',    'noah.h@email.com',           SHA2('pass1234',256),  'noahh',       '2024-01-18 16:00:00', 'customer'),
('Olivia',    'Martin',    'olivia.m@email.com',         SHA2('pass1234',256),  'oliviam',     '2024-01-19 10:10:00', 'customer'),
('Paul',      'Garcia',    'paul.g@email.com',           SHA2('pass1234',256),  'paulg',       '2024-01-20 14:45:00', 'customer'),
('Quinn',     'Martinez',  'quinn.m@email.com',          SHA2('pass1234',256),  'quinnm',      '2024-01-21 08:50:00', 'customer'),
('Rachel',    'Robinson',  'rachel.r@email.com',         SHA2('pass1234',256),  'rachelr',     '2024-01-22 13:15:00', 'customer'),
('Sam',       'Clark',     'sam.c@email.com',            SHA2('pass1234',256),  'samc',        '2024-01-23 11:00:00', 'customer'),
('Tina',      'Rodriguez', 'tina.r@email.com',           SHA2('pass1234',256),  'tinar',       '2024-01-24 09:45:00', 'customer'),
('Uma',       'Lewis',     'uma.l@email.com',            SHA2('pass1234',256),  'umal',        '2024-01-25 15:00:00', 'customer'),
('Victor',    'Lee',       'victor.l@email.com',         SHA2('pass1234',256),  'victorl',     '2024-01-26 10:30:00', 'customer'),
('Wendy',     'Walker',    'wendy.w@email.com',          SHA2('pass1234',256),  'wendyw',      '2024-01-27 08:15:00', 'customer'),
('Xander',    'Hall',      'xander.h@email.com',         SHA2('pass1234',256),  'xanderh',     '2024-01-28 12:30:00', 'customer'),
('Yara',      'Allen',     'yara.a@email.com',           SHA2('pass1234',256),  'yaraa',       '2024-01-29 14:00:00', 'customer'),
('Zoe',       'Young',     'zoe.y@email.com',            SHA2('pass1234',256),  'zoey',        '2024-01-30 09:00:00', 'customer'),
('Aaron',     'Hernandez', 'aaron.h@email.com',          SHA2('pass1234',256),  'aaronh',      '2024-02-01 10:00:00', 'customer'),
('Bella',     'King',      'bella.k@email.com',          SHA2('pass1234',256),  'bellak',      '2024-02-02 11:00:00', 'customer'),
('Carlos',    'Wright',    'carlos.w@email.com',         SHA2('pass1234',256),  'carlosw',     '2024-02-03 13:00:00', 'customer'),
('Diana',     'Lopez',     'diana.l@email.com',          SHA2('pass1234',256),  'dianal',      '2024-02-04 15:00:00', 'customer'),
('Ethan',     'Hill',      'ethan.h@email.com',          SHA2('pass1234',256),  'ethanh',      '2024-02-05 08:00:00', 'driver'),
('Fiona',     'Scott',     'fiona.s@email.com',          SHA2('pass1234',256),  'fionas',      '2024-02-06 09:00:00', 'driver'),
('George',    'Green',     'george.g@email.com',         SHA2('pass1234',256),  'georgeg',     '2024-02-07 10:00:00', 'driver'),
('Hannah',    'Adams',     'hannah.a@email.com',         SHA2('pass1234',256),  'hannaha',     '2024-02-08 11:00:00', 'driver'),
('Ivan',      'Baker',     'ivan.b@email.com',           SHA2('pass1234',256),  'ivanb',       '2024-02-09 12:00:00', 'driver'),
('Julia',     'Gonzalez',  'julia.g@email.com',          SHA2('pass1234',256),  'juliag',      '2024-02-10 13:00:00', 'driver'),
('Kevin',     'Nelson',    'kevin.n@email.com',          SHA2('pass1234',256),  'kevinn',      '2024-02-11 14:00:00', 'driver'),
('Laura',     'Carter',    'laura.c@email.com',          SHA2('pass1234',256),  'laurac',      '2024-02-12 15:00:00', 'driver'),
('Mike',      'Mitchell',  'mike.m@email.com',           SHA2('pass1234',256),  'mikem',       '2024-02-13 08:30:00', 'driver'),
('Nina',      'Perez',     'nina.p@email.com',           SHA2('pass1234',256),  'ninap',       '2024-02-14 09:30:00', 'driver'),
('Oscar',     'Roberts',   'oscar.r@email.com',          SHA2('pass1234',256),  'oscarr',      '2024-02-15 10:30:00', 'driver'),
('Paula',     'Turner',    'paula.t@email.com',          SHA2('pass1234',256),  'paulat',      '2024-02-16 11:30:00', 'driver'),
('Robert',    'Phillips',  'robert.p@email.com',         SHA2('pass1234',256),  'robertp',     '2024-02-17 12:30:00', 'admin'),
('Susan',     'Campbell',  'susan.c@email.com',          SHA2('pass1234',256),  'susanc',      '2024-02-18 13:30:00', 'admin'),
('Thomas',    'Parker',    'thomas.p@email.com',         SHA2('pass1234',256),  'thomasp',     '2024-02-19 14:30:00', 'admin');

-- ============================================================
-- 2. USER_PHONE (45 records — some users have 2 phones)
-- ============================================================
...
('+1-555-0139', 39),
('+1-555-0140', 40),
-- second phone numbers for some users
('+1-555-9001', 1),
('+1-555-9002', 5),
('+1-555-9003', 10),
('+1-555-9004', 15),
...
-- extra addresses (no user — for delivery drop points)
...
-- ============================================================
-- 4. RESTAURANT (10 records — referenced by many other tables)
-- ============================================================
...
-- ============================================================
-- 6. RESTAURANT_PHONE (40 records — each restaurant has 4 phones)
-- ============================================================
...
-- ============================================================
-- 8. ORDERS (45 records — UserIDs 1-30 are customers)
-- ============================================================
INSERT INTO ORDERS (UserID, Status, TotalPrice, OrderDate) VALUES
(1,  'delivered',        24.97, '2024-03-01 12:00:00'),
(2,  'delivered',        27.98, '2024-03-01 12:30:00'),
(3,  'delivered',        31.96, '2024-03-01 13:00:00'),
(4,  'delivered',        19.98, '2024-03-02 11:00:00'),
(5,  'delivered',        43.97, '2024-03-02 12:00:00'),
(6,  'delivered',        28.97, '2024-03-02 13:30:00'),
(7,  'delivered',        36.98, '2024-03-03 11:30:00'),
(8,  'delivered',        15.98, '2024-03-03 12:00:00'),
(9,  'delivered',        26.98, '2024-03-03 13:00:00'),
(10, 'delivered',        41.97, '2024-03-04 11:00:00'),
(11, 'delivered',        22.98, '2024-03-04 12:30:00'),
(12, 'delivered',        33.98, '2024-03-04 13:00:00'),
(13, 'delivered',        19.48, '2024-03-05 11:00:00'),
(14, 'delivered',        29.98, '2024-03-05 12:00:00'),
(15, 'delivered',        38.97, '2024-03-05 13:30:00'),
(16, 'delivered',        24.48, '2024-03-06 11:00:00'),
(17, 'delivered',        31.98, '2024-03-06 12:00:00'),
(18, 'delivered',        27.98, '2024-03-07 11:30:00'),
(19, 'delivered',        22.98, '2024-03-07 12:00:00'),
(20, 'delivered',        35.97, '2024-03-07 13:00:00'),
(21, 'delivered',        18.98, '2024-03-08 11:00:00'),
(22, 'delivered',        44.97, '2024-03-08 12:30:00'),
(23, 'delivered',        26.98, '2024-03-08 13:00:00'),
(24, 'delivered',        31.48, '2024-03-09 11:00:00'),
(25, 'delivered',        23.98, '2024-03-09 12:00:00'),
(26, 'delivered',        39.97, '2024-03-09 13:30:00'),
(27, 'delivered',        28.48, '2024-03-10 11:00:00'),
(28, 'delivered',        33.97, '2024-03-10 12:00:00'),
(29, 'delivered',        21.98, '2024-03-10 13:00:00'),
(30, 'delivered',        47.97, '2024-03-11 11:00:00'),
(1,  'delivered',        15.98, '2024-03-12 12:00:00'),
(3,  'delivered',        28.98, '2024-03-12 13:00:00'),
(5,  'cancelled',        22.98, '2024-03-13 11:00:00'),
(7,  'delivered',        36.97, '2024-03-13 12:30:00'),
(9,  'delivered',        19.98, '2024-03-14 11:00:00'),
(11, 'preparing',        31.97, '2024-03-15 12:00:00'),
(13, 'confirmed',        26.98, '2024-03-15 13:00:00'),
(15, 'pending',          18.98, '2024-03-16 11:00:00'),
(17, 'out_for_delivery', 42.97, '2024-03-16 12:00:00'),
(19, 'delivered',        24.98, '2024-03-17 11:30:00'),
(21, 'delivered',        33.97, '2024-03-17 12:00:00'),
(23, 'delivered',        27.48, '2024-03-18 11:00:00'),
(25, 'delivered',        21.98, '2024-03-18 12:30:00'),
(27, 'cancelled',        16.98, '2024-03-19 11:00:00'),
...
-- Order 1: Burger Barn items
(1,  1, 2,  9.99),  -- Classic Cheeseburger x2
(1,  4, 1,  4.99),  -- Loaded Fries
-- Order 2: Pizza Palace
(2,  6, 1, 11.99),  -- Margherita Pizza
(2,  9, 2,  4.49),  -- Garlic Bread x2
-- Order 3: Sushi Sensation
(3, 11, 1, 12.99),  -- Salmon Nigiri
(3, 12, 1, 15.99),  -- Dragon Roll
-- Order 4: Taco Town
(4, 16, 2,  8.99),  -- Street Tacos x2
-- Order 5: Pasta Place
(5, 21, 1, 13.99),  -- Spaghetti Carbonara
(5, 23, 1, 14.99),  -- Lasagna
(5, 25, 2,  5.49),  -- Panna Cotta x2
-- Order 6: Curry Corner
(6, 26, 1, 14.99),  -- Butter Chicken
(6, 29, 2,  3.99),  -- Garlic Naan x2
-- Order 7: BBQ Brothers
(7, 31, 1, 24.99),  -- Full Rack Ribs
(7, 34, 1,  6.99),  -- Mac and Cheese
-- Order 8: Green Garden
(8, 36, 1, 12.99),  -- Quinoa Bowl
-- Order 9: Noodle House
(9, 41, 1, 13.99),  -- Beef Pho
(9, 43, 1, 14.99),  -- Ramen
-- Order 10: Breakfast Club
(10,46, 2,  9.99),  -- Pancake Stack x2
(10,47, 1, 12.99),  -- Eggs Benedict
-- Order 11: Burger Barn
(11, 2, 1, 13.49),  -- Bacon Double Burger
(11, 5, 2,  4.99),  -- Milkshake x2
-- Order 12: Sushi Sensation
(12,13, 1, 16.99),  -- Tuna Sashimi
(12,14, 2,  2.99),  -- Miso Soup x2
-- Order 13: Taco Town
(13,18, 1, 11.99),  -- Nachos
(13,20, 1,  4.49),  -- Churros
-- Order 14: Pasta Place
(14,22, 1, 12.99),  -- Fettuccine Alfredo
(14,24, 1,  5.99),  -- Bruschetta
-- Order 15: Curry Corner
(15,27, 1, 16.99),  -- Lamb Rogan Josh
(15,28, 1, 12.99),  -- Veg Biryani
(15,30, 2,  3.49),  -- Mango Lassi x2
-- Order 16: BBQ Brothers
(16,32, 1, 11.99),  -- Pulled Pork
(16,35, 1,  4.99),  -- Banana Pudding
-- Order 17: Green Garden
(17,37, 1,  9.99),  -- Caesar Salad
(17,40, 1, 10.99),  -- Acai Bowl
-- Order 18: Noodle House
(18,42, 1, 12.99),  -- Pad Thai
(18,44, 1,  6.99),  -- Spring Rolls
-- Order 19: Breakfast Club
(19,49, 1,  8.99),  -- French Toast
(19,50, 2,  3.99),  -- Orange Juice x2
-- Order 20: Burger Barn + extras
(20, 1, 1,  9.99),  -- Classic Cheeseburger
(20, 3, 1, 10.99),  -- Veggie Burger
(20, 4, 2,  5.99),  -- Loaded Fries x2
-- Order 21: Pizza Palace
(21, 7, 1, 13.99),  -- Pepperoni Pizza
-- Order 22: Sushi Sensation
(22,11, 2, 12.99),  -- Salmon Nigiri x2
(22,15, 2,  3.49);  -- Edamame x2

-- ============================================================
-- 10. PAYMENT (45 records — one per order)
-- ============================================================
...
-- ============================================================
-- 11. DELIVERY (40 records — only delivered/out_for_delivery orders)
--     Driver UserIDs: 31-42  |  AddressIDs: 1-40
-- ============================================================
...
-- ============================================================
-- 12. FEEDBACK (40 records — only on delivered orders)
-- ============================================================
